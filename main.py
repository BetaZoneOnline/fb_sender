...
def main() -> int:
    ...
    browser_host.ensure_window(profile_manager.profile_storage_path)
    worker_factory = lambda: build_worker(
        browser_host.ensure_view(profile_manager.profile_storage_path)
    )
